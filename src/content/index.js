export default {
  ...
  header: {
    img: process.env.PUBLIC_URL + '/assets/headshot.png',
    imgPlaceholder:
  ...
  work: {
    title: 'Projects',
    img: process.env.PUBLIC_URL + '/assets/AppScreenShot.png',
    imgPlaceholder:
    ...
    projectName: 'BudgeGrub',
    desc:
      'track your expenses and get food within your budget.',
  },
  ...
  stack: {
    ...
    desc: `I graduated from UM BootCamp in June 2021. I've worked with MERN stack but love to learn new technologies. I have worked in FinTech for 10+ years. I want to leverage my coding knowledge in the financial sector - particularly global remittance and blockchain tech`,
  },
  contact: {
    title: 'Ping Me!',
    desc:
      "Hit me up on linkedin or follow me on Github.",
    socials: [
      {
        alt: 'facebook',
